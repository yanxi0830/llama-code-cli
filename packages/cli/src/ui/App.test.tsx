  ...
  const ConfigClassMock = vi
    ...
    .mockImplementation((optionsPassedToConstructor) => {
      ...
      return {
        ...
        getAllGeminiMdFilenames: vi.fn(() => ['LLAMA.md']),
...
describe('App UI', () => {
  ...
  it('should display active file and other context', async () => {
    ...
    mockConfig.getAllGeminiMdFilenames.mockReturnValue(['LLAMA.md']);
    ...
    await Promise.resolve();
    expect(lastFrame()).toContain(
      'Using: 1 open file (ctrl+e to view) | 1 LLAMA.md file',
    );
  });

  it('should display default "LLAMA.md" in footer when contextFileName is not set and count is 1', async () => {
    mockConfig.getGeminiMdFileCount.mockReturnValue(1);
    mockConfig.getAllGeminiMdFilenames.mockReturnValue(['LLAMA.md']);
    ...
    expect(lastFrame()).toContain('Using: 1 LLAMA.md file');
  });

  it('should display default "LLAMA.md" with plural when contextFileName is not set and count is > 1', async () => {
    mockConfig.getGeminiMdFileCount.mockReturnValue(2);
    mockConfig.getAllGeminiMdFilenames.mockReturnValue(['LLAMA.md', 'LLAMA.md']);
    mockConfig.getDebugMode.mockReturnValue(false);
    mockConfig.getShowMemoryUsage.mockReturnValue(false);
    ...
    currentUnmount = unmount;
    await Promise.resolve();
    expect(lastFrame()).toContain('Using: 2 LLAMA.md files');
  });
  ...
  it('should display LLAMA.md and MCP server count when both are present', async () => {
    mockConfig.getGeminiMdFileCount.mockReturnValue(2);
    mockConfig.getAllGeminiMdFilenames.mockReturnValue(['LLAMA.md', 'LLAMA.md']);
  ...
  it('should display only MCP server count when LLAMA.md count is 0', async () => {
    mockConfig.getGeminiMdFileCount.mockReturnValue(0);
    mockConfig.getAllGeminiMdFilenames.mockReturnValue([]);
    mockConfig.getMcpServers.mockReturnValue({
      server1: {} as MCPServerConfig,
